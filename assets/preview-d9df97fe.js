import{w as y}from"./window-6922176c.js";import{d as O}from"./index-356e4a49.js";import"./_commonjsHelpers-35101cd5.js";var p="backgrounds",{document:s,window:M}=y,v=()=>M.matchMedia("(prefers-reduced-motion: reduce)").matches,k=(r,e=[],d)=>{if(r==="transparent")return"transparent";if(e.find(a=>a.value===r))return r;let t=e.find(a=>a.name===d);if(t)return t.value;if(d){let a=e.map(i=>i.name).join(", ");__STORYBOOK_MODULE_CLIENT_LOGGER__.logger.warn(O`
...
//# sourceMappingURL=preview-d9df97fe.js.map
